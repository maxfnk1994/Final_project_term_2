...
Thus the relations of the different variables in connection with the characteristics Revenue = yes and Revenue = no are 
examined. Finally, the correlations are presented.
...
inspected by e.g. PageValues or Special day. If these differences are significant will be analysed in the next section 
Hypothesis Testing.
...
### Summary
***
It could be statistically proven that significant differences between Revenue = yes and Revenue = no regarding variables in 
the data set, such as bounce rates:
It could be demonstrated that if Revenue = no, the Bounce Rates are greater in comparison Revenue = yes. This approach in 
...
Revenue = -1.980645 + 0.005385 * Product Related -  19.603015 * Exit Rate + 0.081696 Page Value – 0.867538 Special Day
